...
<table width="100%"  border="0" align="left" cellpadding="0" cellspacing="1" class="mytable"  id="mytable">
    ...
    <td><?php echo Form\Html::Input($m->_LoginName);?></td>
  </tr>
    <tr>
    ...
    <tr>
    <td width="126"><div align="right">职务：</div></td>
    <td><?php echo Form\Html::Input($m->_Address);?></td>
  </tr>
    <tr>
    <td width="126"><div align="right">密码：</div></td>
    <td><?php echo Form\Html::Input($m->_LoginPass);?>留空不修改</td>
  </tr>
    
    <tr>
    <td width="126"><div align="right">状态：</div></td>
    <td><?php echo Form\Html::Radio($m->_State,['1'=>'正常','0'=>'锁定','-1'=>'黑名单']);?></td>
  </tr>
  <tr>
