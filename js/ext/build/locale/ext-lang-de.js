...
Ext.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">"Ubertrage Daten ...</div>';
...
if(Ext.grid.Grid){
   Ext.grid.Grid.prototype.ddText = "{0} Zeile(n) ausgew"ahlt";
}

if(Ext.TabPanelItem){
   Ext.TabPanelItem.prototype.closeText = "Diesen Tab schliessen";
}
...
if(Ext.LoadMask){
  Ext.LoadMask.prototype.msg = ""Ubertrage Daten...";
}
...
if(Ext.DatePicker){
   Ext.apply(Ext.DatePicker.prototype, {
      todayText         : "Heute",
      minText           : "Dieses Datum liegt von dem erstm"oglichen Datum",
      maxText           : "Dieses Datum liegt nach dem letztm"oglichen Datum",
      disabledDaysText  : "",
      disabledDatesText : "",
      monthNames	    : Date.monthNames,
      dayNames		    : Date.dayNames,
      nextText          : "N"achster Monat (Strg/Control + Rechts)",
      prevText          : "Vorheriger Monat (Strg/Control + Links)",
      monthYearText     : "Monat ausw"ahlen (Strg/Control + Hoch/Runter, um ein Jahr auszuw"ahlen)",
...
if(Ext.form.DateField){
   Ext.apply(Ext.form.DateField.prototype, {
      ...
      invalidText       : "{0} ist kein valides Datum - es muss im Format {1} eingegeben werden",
      format            : "d.m.Y",
...
if(Ext.form.HtmlEditor){
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    ...
    buttonTips : {
      bold : {
        title: 'Fett (Ctrl+B)',
        text: 'Erstellt den ausgew"ahlten Text in Fettschrift.',
        cls: 'x-html-editor-tip'
      },
      italic : {
        title: 'Kursiv (Ctrl+I)',
        text: 'Erstellt den ausgew"ahlten Text in Schr"agschrift.',
        cls: 'x-html-editor-tip'
      },
      underline : {
        title: 'Unterstrichen (Ctrl+U)',
        text: 'Unterstreicht den ausgew"ahlten Text.',
        cls: 'x-html-editor-tip'
      },
      increasefontsize : {
        title: 'Text verg"ossern',
        text: 'Erh"oht die Schriftgr"osse.',
        cls: 'x-html-editor-tip'
      },
      decreasefontsize : {
        title: 'Text verkleinern',
        text: 'Verringert die Schriftgr"osse.',
        cls: 'x-html-editor-tip'
      },
      backcolor : {
        title: 'Text farblich hervorheben',
        text: 'Hintergrundfarbe des ausgew"ahlten Textes "andern.',
        cls: 'x-html-editor-tip'
      },
      forecolor : {
        title: 'Schriftfarbe',
        text: 'Farbe des ausgew"ahlten Textes "andern.',
        cls: 'x-html-editor-tip'
      },
      justifyleft : {
        title: 'Linksbündig',
      ...
      insertunorderedlist : {
        title: 'Aufz"ahlungsliste',
        text: 'Beginnt eine Aufz"ahlungsliste mit Spiegelstrichen.',
        cls: 'x-html-editor-tip'
      },
      insertorderedlist : {
      ...
      createlink : {
        title: 'Hyperlink',
        text: 'Erstellt einen Hyperlink aus dem ausgew"ahlten text.',
        cls: 'x-html-editor-tip'
      },
      sourceedit : {
...
if(Ext.layout.BorderLayout.SplitRegion){
  Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
    splitTip            : "Ziehen, um Gr"osse zu "andern.",
    collapsibleSplitTip : "Ziehen, um Gr"osse zu "andern. Doppelklick um Panel auszublenden."
  });
}
