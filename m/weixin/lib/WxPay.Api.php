<?php
require_once $_SERVER['DOCUMENT_ROOT']."/m/weixin/lib/WxPay.Exception.php";
require_once $_SERVER['DOCUMENT_ROOT']."/m/weixin/lib/WxPay.Config.php";
require_once $_SERVER['DOCUMENT_ROOT']."/m/weixin/lib/WxPay.Data.php";
...
class WxPayApi
{
	...
	{		
		...
		if(WxPayConfig::CURL_PROXY_HOST != "0.0.0.0" 
			...
			curl_setopt($ch,CURLOPT_PROXY, $_SERVER['DOCUMENT_ROOT'].WxPayConfig::CURL_PROXY_HOST);
			curl_setopt($ch,CURLOPT_PROXYPORT, $_SERVER['DOCUMENT_ROOT'].WxPayConfig::CURL_PROXY_PORT);
		}
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, $_SERVER['DOCUMENT_ROOT'].WxPayConfig::SSLCERT_PATH);
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, $_SERVER['DOCUMENT_ROOT'].WxPayConfig::SSLKEY_PATH);
		}
		//post提交方式
