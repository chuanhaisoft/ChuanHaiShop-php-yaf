/**
 * Slovenian translation by Matjaz (UTF-8 encoding)
 * 25 April 2007
 */
...
if(Ext.DatePicker){
   Ext.apply(Ext.DatePicker.prototype, {
      ...
      prevText          : 'Prejsnji mesec (Control+Levo)',
...
if(Ext.form.TextField){
   Ext.apply(Ext.form.TextField.prototype, {
      minLengthText : "Minimalna dolzina tega polja je {0}",
      maxLengthText : "Maksimalna dolzina tega polja je {0}",
...
if(Ext.form.NumberField){
   Ext.apply(Ext.form.NumberField.prototype, {
      ...
      nanText : "{0} ni veljavna stevilka"
   });
}

if(Ext.form.DateField){
   Ext.apply(Ext.form.DateField.prototype, {
      disabledDaysText  : "Onemogocen",
      disabledDatesText : "Onemogocen",
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      ...
      alphaText    : 'To polje lahko vsebuje samo crke in _',
      alphanumText : 'To polje lahko vsebuje samo crke, stevilke in _'
   });
}

if(Ext.grid.GridView){
   Ext.apply(Ext.grid.GridView.prototype, {
      sortAscText  : "Sortiraj narascajoce",
      sortDescText : "Sortiraj padajoce",
...
if(Ext.layout.BorderLayout.SplitRegion){
   Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
      splitTip            : "Potegni za razsiritev.",
      collapsibleSplitTip : "Potegni za razsiritev. Dvojni klik, ce zelite skriti."
   });
}