...
<table width="100%"  border="0" align="left" cellpadding="0" cellspacing="1" class="mytable"  id="mytable">
    ...
    <td width="126"><div align="right">当前惠点：</div></td>
  ...
  <tr>
    ...
    <tr>
    <td width="126"><div align="right">加减惠点：</div></td>
    <td><?php echo Form\Html::Input($m->_Point);?>谨慎操作<br/>加10请输入10,减请输入负数</td>
  </tr>
       <tr>
