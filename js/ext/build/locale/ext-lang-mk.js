...
if(Ext.DatePicker){
   Ext.apply(Ext.DatePicker.prototype, {
      todayText         : "Денеска",
      minText           : "Ово датум е пред намалиот датум",
      maxText           : "Ово датум е пред наголемиот датум",
      disabledDaysText  : "",
      disabledDatesText : "",
      ...
      monthYearText     : 'Изберете месец (Control+Стрелка горе/Стрелка десно за менувае година)',
      todayTip          : "{0} (Spacebar)",
      format            : "d.m.y"
   });
}
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      ...
      alphanumText : 'Ова поле треба да содржи само букви, броки и _'
   });
}
...
if(Ext.layout.BorderLayout.SplitRegion){
   Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
      splitTip            : "Повлечете за менувае на големината.",
      collapsibleSplitTip : "Повлечете за менувае на големината. Дупли клик за криее."
   });
}