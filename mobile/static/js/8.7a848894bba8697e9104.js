...
// load the styles
var content = __webpack_require__("u3Y2");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("7ec50bf9", content, true, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5e440886_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_footer_vue__ = __webpack_require__("E3E0");
function injectStyle (ssrContext) {
  __webpack_require__("o1F1")
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-5e440886"
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5e440886_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_footer_vue__["a" /* default */],
...
// load the styles
var content = __webpack_require__("+C9q");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('van-tabbar',{model:{value:(_vm.active),callback:function ($$v) {_vm.active=$$v},expression:"active"}},[_c('van-tabbar-item',{attrs:{"icon":"home","to":"/"}},[_vm._v("首页")]),_vm._v(" "),_c('van-tabbar-item',{attrs:{"icon":"shop","to":"/category"}},[_vm._v("分类")]),_vm._v(" "),_c('van-tabbar-item',{attrs:{"icon":"cart","to":"/car"}},[_vm._v("购物车")]),_vm._v(" "),_c('van-tabbar-item',{attrs:{"icon":"contact","to":"/user"}},[_vm._v("我的")]),_vm._v(" "),_c('van-tabbar-item',{attrs:{"icon":"chat","to":"/im","dot":_vm.isNewChat}},[_vm._v("客服")])],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
// module
exports.push([module.i, "div[data-v-55ca0448]{padding:8vw 0;text-align:center;letter-spacing:.2vw;color:#9e9e9e;font-family:Lato,Microsoft Jhenghei,Hiragino Sans GB,Microsoft YaHei,sans-serif;font-weight:600;font-size:14px}", ""]);
...
// load the styles
var content = __webpack_require__("Urso");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("85e3524a", content, true, {});
...
// module
exports.push([module.i, ".van-tabbar-item--active[data-v-5e440886]{color:#f23030}.van-tabbar-item[data-v-5e440886]{cursor:pointer}.van-tabbar[data-v-5e440886]{height:55px}", ""]);
...
__WEBPACK_IMPORTED_MODULE_5_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_2_vant__["n" /* default */]);
...
/* harmony default export */ __webpack_exports__["a"] = ({
          ...
          _this.$dopost('/sysapi/user/mobile_code/', obj, function (res) {
            if (res.data && typeof res.data.error != "undefined" && res.data.error === 0) {
              if (res.data.data.state && res.data.data.state == 'ok') {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vant__["a" /* Toast */])('发送成功！');
              } else {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vant__["a" /* Toast */])('发送失败！');
              }
            } else {
              __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vant__["a" /* Toast */])(res.data && res.data.mess ? res.data.mess : '出错了！');
            }
          }.bind(_this), true);
        },
        //发送完成后的回调
  ...
  methods: {
      ...
      if (this.account && this.account !== "" && this.password && this.password !== "") {
        ...
        this.$dopost('/sysapi/user/reg/', { 'login_name': this.account, 'login_pass': this.password, 'mobile_code': this.sms }, function (response) {
          if (response.data && typeof response.data.error != "undefined" && response.data.error === 0) {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vant__["a" /* Toast */])(response.data && response.data.mess ? response.data.mess : '出错了!');
          }
        }.bind(this));
      } else {
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vant__["a" /* Toast */])('账号密码不能为空');
      }
      /** 
            setTimeout(()=>{
              this.$router.replace({
    ...
    sendMess: function sendMess() {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vant__["a" /* Toast */])('sendMess');
    }
  }
});
...
// load the styles
var content = __webpack_require__("i1qK");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("0c94800b", content, true, {});
...
// module
exports.push([module.i, ".login>section[data-v-117853bd]{margin-top:10px}.login>section .tip[data-v-117853bd]{padding:6vw 3vw;color:#e09147;letter-spacing:2px;font-size:16px}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vant__ = __webpack_require__("Fd2+");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vant_lib_vant_css_index_css__ = __webpack_require__("CMvz");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vant_lib_vant_css_index_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vant_lib_vant_css_index_css__);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  components: (_components = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_components, __WEBPACK_IMPORTED_MODULE_1_vant__["l" /* Tabbar */].name, __WEBPACK_IMPORTED_MODULE_1_vant__["l" /* Tabbar */]), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_components, __WEBPACK_IMPORTED_MODULE_1_vant__["m" /* TabbarItem */].name, __WEBPACK_IMPORTED_MODULE_1_vant__["m" /* TabbarItem */]), _components),
  methods: {
  ...
  watch: {
    ...
    '$store.state.im.count': function $storeStateImCount() {
      this.isNewChat = this.$store.state.im.count > 0 ? true : false;
    }
  },
  mounted: function mounted() {
