...
<div id="SearchDiv" style=" padding-bottom:3px;">
 <table width="100%" border="0" cellpadding="0" cellspacing="0"  >
   ...
   <select name="search_type" id="search_type">
    ...
    <div  id="sum_show" style="margin: 10px 0;"></div>
