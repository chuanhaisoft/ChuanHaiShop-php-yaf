...
if(Ext.DatePicker){
  Ext.apply(Ext.DatePicker.prototype, {
    todayText         : "I dag",
    minText           : "Denne datoen er for tidlegaste tillatne dato",
    maxText           : "Denne datoen er etter seinaste tillatne dato",
    disabledDaysText  : "",
    disabledDatesText : "",
    monthNames	      : Date.monthNames,
    dayNames		      : Date.dayNames,
    nextText          : 'Neste manad (Control+Pil Hogre)',
    prevText          : 'Forre manad (Control+Pil Venstre)',
    monthYearText     : 'Velj ein manad (Control+Pil Opp/Ned for a skifte ar)',
...
if(Ext.form.TextField){
  Ext.apply(Ext.form.TextField.prototype, {
    ...
    maxLengthText : "Den storste lengda for dette feltet er {0}",
    blankText     : "Dette feltet er pakravd",
    regexText     : "",
    emptyText     : null
  });
}
...
if(Ext.form.DateField){
  Ext.apply(Ext.form.DateField.prototype, {
    ...
    minText           : "Datoen i dette feltet ma vere etter {0}",
    maxText           : "Datoen i dette feltet ma vere for {0}",
    invalidText       : "{0} er ikkje ein gyldig dato - han ma vere pa formatet {1}",
    format            : "d.m.y",
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      emailText    : 'Dette feltet skal vere ei epost adresse pa formatet "bruker@domene.no"',
      urlText      : 'Dette feltet skal vere ein link (URL) pa formatet "http:/'+'/www.domene.no"',
...
if(Ext.form.HtmlEditor){
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    ...
    buttonTips : {
      ...
      forecolor : {
        title: 'Font farge',
        text: 'Endre farge pa den valde teksten.',
        cls: 'x-html-editor-tip'
      },
      justifyleft : {
      ...
      justifyright : {
        title: 'Hogrejuster tekst',
        text: 'Hogrejuster teksten.',
        cls: 'x-html-editor-tip'
      },
      insertunorderedlist : {
        title: 'Punktliste',
...
if(Ext.layout.BorderLayout.SplitRegion){
  Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
    splitTip            : "Dra for a endre storleik.",
    collapsibleSplitTip : "Dra for a endre storleik. Dobbelklikk for a skjule."
  });
}
