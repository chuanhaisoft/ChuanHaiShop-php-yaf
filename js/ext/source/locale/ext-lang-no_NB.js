...
/**
 *
 * Norwegian translation (Bokmal: no-NB)
 * By Tore Kjorsvik 21-January-2008
 *  
 */
...
if(Ext.DatePicker){
  Ext.apply(Ext.DatePicker.prototype, {
    todayText         : "I dag",
    minText           : "Denne datoen er for tidligste tillatte dato",
    maxText           : "Denne datoen er etter seneste tillatte dato",
    disabledDaysText  : "",
    disabledDatesText : "",
    monthNames	      : Date.monthNames,
    dayNames		      : Date.dayNames,
    nextText          : 'Neste maned (Control+Pil Hoyre)',
    prevText          : 'Forrige maned (Control+Pil Venstre)',
    monthYearText     : 'Velg en maned (Control+Pil Opp/Ned for a skifte ar)',
...
if(Ext.form.TextField){
  Ext.apply(Ext.form.TextField.prototype, {
    ...
    maxLengthText : "Den storste lengden for dette feltet er {0}",
    blankText     : "Dette feltet er pakrevd",
    regexText     : "",
    emptyText     : null
  });
}
...
if(Ext.form.NumberField){
  Ext.apply(Ext.form.NumberField.prototype, {
    ...
    maxText : "Den storste verdien for dette feltet er {0}",
...
if(Ext.form.DateField){
  Ext.apply(Ext.form.DateField.prototype, {
    ...
    minText           : "Datoen i dette feltet ma vaere etter {0}",
    maxText           : "Datoen i dette feltet ma vaere for {0}",
    invalidText       : "{0} er ikke en gyldig dato - den ma vaere pa formatet {1}",
    format            : "d.m.y",
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      emailText    : 'Dette feltet skal vaere en epost adresse pa formatet "bruker@domene.no"',
      urlText      : 'Dette feltet skal vaere en link (URL) pa formatet "http:/'+'/www.domene.no"',
...
if(Ext.form.HtmlEditor){
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    ...
    buttonTips : {
      bold : {
        title: 'Fet (Ctrl+B)',
        text: 'Gjor den valgte teksten fet.',
        cls: 'x-html-editor-tip'
      },
      italic : {
        title: 'Kursiv (Ctrl+I)',
        text: 'Gjor den valgte teksten kursiv.',
        cls: 'x-html-editor-tip'
      },
      underline : {
      ...
      increasefontsize : {
        title: 'Forstorr tekst',
        text: 'Gjor fontstorrelse storre.',
        cls: 'x-html-editor-tip'
      },
      decreasefontsize : {
        title: 'Forminsk tekst',
        text: 'Gjor fontstorrelse mindre.',
        cls: 'x-html-editor-tip'
      },
      backcolor : {
      ...
      forecolor : {
        title: 'Font farge',
        text: 'Endre farge pa den valgte teksten.',
        cls: 'x-html-editor-tip'
      },
      justifyleft : {
      ...
      justifyright : {
        title: 'Hoyrejuster tekst',
        text: 'Hoyrejuster teksten.',
        cls: 'x-html-editor-tip'
      },
      insertunorderedlist : {
        title: 'Punktliste',
      ...
      createlink : {
        title: 'Lenke',
        text: 'Gjor den valgte teksten til en lenke.',
        cls: 'x-html-editor-tip'
      },
      sourceedit : {
        title: 'Rediger kilde',
...
if(Ext.grid.GridView){
  Ext.apply(Ext.grid.GridView.prototype, {
    ...
    lockText     : "Las kolonne",
    unlockText   : "Las opp kolonne",
...
if(Ext.layout.BorderLayout.SplitRegion){
  Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
    splitTip            : "Dra for a endre storrelse.",
    collapsibleSplitTip : "Dra for a endre storrelse. Dobbelklikk for a skjule."
  });
}
