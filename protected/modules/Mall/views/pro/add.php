...
if(false)$pro_mess=new \Model\ProMess();
	...
	{  
		...
		success:function(data) {  
			...
			if(data){
				...
				data = '<a style="    background: #0AE; color:#fff;border-radius: 4px; padding: 2px 5px;" target="_blank" href="javascript:parent.window.OpenUrl(\'/mall/gui_ge/list.html\',400,\'规格管理\')" class="button">设置</a>'
				$("#gui_ge_div").html(data);
			}
...
<table width="100%"  border="0" align="left" cellpadding="0" cellspacing="1" class="mytable">
    ...
    <td>
    <?php \Pub\Yaf::display('mall-sort-select',['OnChange'=>'']); ?>
    <?php  //$this->renderPartial('mall.views.web.mall_sort_select',array('OnChange'=>'')); ?><span id="mall_sort_error"  class="invalid"></span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><?php \Pub\Yaf::display('yun-fei-select'); ?>
  ...
  <tr>
    ...
    <td>
            图1:<?php echo Form\Html::Input($pro_mess->_Pic1,null,['width'=>'60px']);?><script type="text/javascript">document.write(UploadText('PIC1'))</script>
            图2:<?php echo Form\Html::Input($pro_mess->_Pic2,null,['width'=>'60px']);?><script type="text/javascript">document.write(UploadText('PIC2'))</script>
            图3:<?php echo Form\Html::Input($pro_mess->_Pic3,null,['width'=>'60px']);?><script type="text/javascript">document.write(UploadText('PIC3'))</script>
            图4:<?php echo Form\Html::Input($pro_mess->_Pic4,null,['width'=>'60px']);?><script type="text/javascript">document.write(UploadText('PIC4'))</script>
            图5:<?php echo Form\Html::Input($pro_mess->_Pic5,null,['width'=>'60px']);?><script type="text/javascript">document.write(UploadText('PIC5'))</script>
	</td>
  </tr>
    <tr>
	...
	<table id="dynamicTable"  border="0" cellspacing="0" cellpadding="0">
		<tbody>
			<tr>
				...
				<td align="center" style="display:none;">余额额度：<input type="text" id="1_can_use_yu_e" name="1_can_use_yu_e" style="width:80px" value="0" /> </td>
...
<script type="text/javascript">
	...
	<td ><div style="width:85%"><?php \Pub\Yaf::display('uedit',['content'=>'商品介绍']); ?></div>
...
function CheckForm()
{
	...
	mall_sort_select_ids = $('#mall_sort_select_ids').val();
	if(!mall_sort_select_ids){
		alert('请选择商品分类!');
		return false;
	}
...
// 	ss = JSON.stringify(gei_ge_json); 
    ...
    for( i=0; i<inArr.length; i++ )
    {
		...
		{
            value1='abc';//$("input[name='"+inArr[i].value+"_xing_hao']").val();
