...
require_once $_SERVER['DOCUMENT_ROOT']."/m/weixin/example/WxPay.JsApiPay.php";
...
$input->SetNotify_url("http://www.hflin.com/pay/notify.html");
$input->SetTrade_type("JSAPI");
$input->SetOpenid($openId);
$order = WxPayApi::unifiedOrder($input);
echo '<font color="#f00"><b>充值</b></font><br/>';
printf_info($order);
