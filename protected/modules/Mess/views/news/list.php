...
function SubSort(value, cellmeta, record)
{
	Str ="<a href='javascript:OpenOrderUrl2("+record.data["ID"]+")' >下级分类</a>";
	try{return Str;}finally{Str = null;}
}

function OpenOrderUrl2(value)
{
	window.parent.OpenExtIframWindow2("/mess/sort/list.html?Refresh=1&sort_big="+value ,"分类管理",0.95,0.89);//Mark + "Add",
}
