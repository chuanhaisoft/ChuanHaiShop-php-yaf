...
if(Ext.grid.Grid){
   Ext.grid.Grid.prototype.ddText = "{0} markerede raekker";
}
...
if(Ext.form.Field){
   Ext.form.Field.prototype.invalidText = "Vaerdien i dette felt er ugyldig";
}
...
if(Ext.DatePicker){
   Ext.apply(Ext.DatePicker.prototype, {
      todayText         : "I dag",
      minText           : "Denne dato er for den tidligst tilladte",
      maxText           : "Denne dato er senere end den senest tilladte",
      disabledDaysText  : "",
      disabledDatesText : "",
      monthNames        : Date.monthNames,
      dayNames          : Date.dayNames,      
      nextText          : 'Naeste maned (Ctrl + hojre piltast)',
      prevText          : 'Forrige maned (Ctrl + venstre piltast)',
      monthYearText     : 'Vaelg en maned (Ctrl + op/ned pil for at aendre arstal)',
...
if(Ext.form.TextField){
   Ext.apply(Ext.form.TextField.prototype, {
      minLengthText : "Minimum laengden for dette felt er {0}",
      maxLengthText : "Maksimum laengden for dette felt er {0}",
...
if(Ext.form.NumberField){
   Ext.apply(Ext.form.NumberField.prototype, {
      minText : "Mindste-vaerdien for dette felt er {0}",
      maxText : "Maksimum-vaerdien for dette felt er {0}",
...
if(Ext.form.DateField){
   Ext.apply(Ext.form.DateField.prototype, {
      ...
      minText           : "Datoen i dette felt skal vaere efter {0}",
      maxText           : "Datoen i dette felt skal vaere for {0}",
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      emailText    : 'Dette felt skal vaere en email adresse i formatet "xxx@yyy.zzz"',
      urlText      : 'Dette felt skal vaere en URL i formatet "http:/'+'/xxx.yyy"',
...
if(Ext.form.HtmlEditor){
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    ...
    buttonTips : {
      ...
      increasefontsize : {
        title: 'Forstor tekst',
        text: 'Forog fontstorrelsen.',
        cls: 'x-html-editor-tip'
      },
      decreasefontsize : {
        title: 'Formindsk tekst',
        text: 'Formindsk fontstorrelsen.',
        cls: 'x-html-editor-tip'
      },
      backcolor : {
        title: 'Farve for tekstfremhaevelse',
      ...
      justifyright : {
        title: 'Juster hojre',
        text: 'Hojrestil tekst.',
        cls: 'x-html-editor-tip'
      },
      insertunorderedlist : {
        title: 'Punktopstilling',
        text: 'Pabegynd punktopstilling.',
        cls: 'x-html-editor-tip'
      },
      insertorderedlist : {
        title: 'Nummereret opstilling',
        text: 'Pabegynd nummereret opstilling.',
        cls: 'x-html-editor-tip'
      },
      createlink : {
        title: 'Hyperlink',
...
if(Ext.grid.GridView){
   Ext.apply(Ext.grid.GridView.prototype, {
      ...
      unlockText   : "Fjern las fra kolonne",
...
if(Ext.layout.BorderLayout.SplitRegion){
   Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
      splitTip            : "Traek for at aendre storrelsen.",
      collapsibleSplitTip : "Traek for at aendre storrelsen. Dobbelt-klik for at skjule."
   });
}
