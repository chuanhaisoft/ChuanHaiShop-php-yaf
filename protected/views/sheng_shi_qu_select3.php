...
<script type="text/javascript" src="/upload/cache/sheng_shi.js"></script>
<?php
...
function GetData()
    	    {
    	        $ReturnArr=array();
    	        $User1=\Bll\China::GetList(1, 999,'PID=0');
    	        for($i1=0;$i1<count($User1);$i1++)
    	        {
    	            ...
    	            $User2=\Bll\China::GetList(1, 999,'PID='.$row1['ID']);
    	            for($i2=0;$i2<count($User2);$i2++)
    	            {
    	                ...
    	                for($i3=0;$i3<count($User3);$i3++)
    	                {
    	                    ...
    	                    $User4=\Bll\China::GetList(1, 999,'PID='.$row3['ID']);
